...
typedef enum vltl_sast_operation_kind {
    ...
    VLTL_SAST_OPERATION_KIND_INDEX_OPEN,
    VLTL_SAST_OPERATION_KIND_INDEX_CLOSE,
    VLTL_SAST_OPERATION_KIND_LOAD,
    VLTL_SAST_OPERATION_KIND_LOAD_SRC3,
    VLTL_SAST_OPERATION_KIND_STORE,
    VLTL_SAST_OPERATION_KIND_ADDRESS,
    VLTL_SAST_OPERATION_KIND_LEA,
    VLTL_SAST_OPERATION_KIND_INDIRECTION,
    ...
    VLTL_SAST_OPERATION_KIND_CDECL0,
    VLTL_SAST_OPERATION_KIND_CDECL1,
    VLTL_SAST_OPERATION_KIND_CDECL2,
    VLTL_SAST_OPERATION_KIND_CDECL3,
    VLTL_SAST_OPERATION_KIND_CDECL4,
