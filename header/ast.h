...
typedef enum vltl_ast_operation_kind {
    ...
    VLTL_AST_OPERATION_KIND_ATTRIBUTE,
    ...
    VLTL_AST_OPERATION_KIND_CDECL0,
    VLTL_AST_OPERATION_KIND_CDECL1,
    VLTL_AST_OPERATION_KIND_CDECL2,
    VLTL_AST_OPERATION_KIND_CDECL3,
    VLTL_AST_OPERATION_KIND_CDECL4,

    VLTL_AST_OPERATION_KIND_EOF
