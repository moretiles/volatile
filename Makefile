...
test_asm_files += tests/fullpass/write_several_strings.bin.S
...
vltl_i686_linux: src/core.c libvltl.a
	clang ${STATIC} --target=i686-linux-gnu ${OPTIMIZE} ${CFLAGS} src/core.c -o vltl_i686_linux ${INCLUDE} ${LIBRARIES}
...
vltl_i686_windows.exe: src/core.c libvltl.a
	clang ${STATIC} --target=i686-windows-gnu -DEXFULL=54 ${OPTIMIZE} ${CFLAGS} src/core.c -o vltl_i686_windows ${INCLUDE} ${LIBRARIES} ${LIBRARIES_WINDOWS}
